...
SEED_BRAND = BrandKit(
    ...
    refs=[
        StyleRef(id="ref-1", url="/media/mountains.jpg", note="mountain peaks above cloud sea at dawn"),
        StyleRef(id="ref-2", url="/media/valley.jpg", note="quiet valley, cool palette, no people"),
        StyleRef(id="ref-3", url="/media/boats.jpg", note="wooden boats on still water"),
        StyleRef(id="ref-4", url="/media/hills.jpg", note="rolling hills, natural light"),
        StyleRef(id="ref-5", url="/media/leaves.jpg", note="tree canopy, editorial landscape"),
        StyleRef(id="ref-6", url="/media/mist.jpg", note="misty forest, golden hour"),
        StyleRef(id="ref-7", url="/media/forest.jpg", note="dark forest, moody light"),
    ],
)
